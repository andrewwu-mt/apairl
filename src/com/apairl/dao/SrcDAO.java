...
public class SrcDAO extends HibernateDaoSupport  {
    ...
    public List findByExample(Src instance) {
        log.debug("finding Src instance by example");
        try {
            List results = getSession()
                    .createCriteria("com.apairl.dbo.Src")
    ...
    public Src merge(Src detachedInstance) {
        log.debug("merging Src instance");
        try {
            Src result = (Src) getSession()
    ...
    public void attachDirty(Src instance) {
        log.debug("attaching dirty Src instance");
        try {
    ...
    public void attachClean(Src instance) {
        log.debug("attaching clean Src instance");
        try {
